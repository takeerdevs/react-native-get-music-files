...
public class BlurBuilder extends Application {
    ...
    static Bitmap fastblur(Bitmap sentBitmap, float scale, int radius) {
        ...
        int[] pix = new int[w * h];
        Log.e(GeneralUtils.LOG, "pix : " + w + " " + h + " " + pix.length);
        ...
        Log.e(GeneralUtils.LOG, w + " " + h + " " + pix.length);
        bitmap.setPixels(pix, 0, w, 0, 0, w, h);

        return (bitmap);
    }

    static String saveBluredImage(String pathToImg, @NonNull Bitmap songImage) throws IOException {

        BlurBuilder blur = new BlurBuilder();
